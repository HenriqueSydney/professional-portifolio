      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            {t("intro.part1")}{" "}
            <strong className="text-foreground">{t("intro.highlight")}</strong>{" "}
            {t("intro.part2")}
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
          <div className="animate-slide-up">
            ...
            <div className="space-y-4 text-muted-foreground">
              <p>
                {t("journey.paragraphs.p1.part1")}{" "}
                <strong className="text-foreground">
                  {t("journey.paragraphs.p1.highlight1")}
                </strong>
                , {t("journey.paragraphs.p1.part2")}{" "}
                <strong className="text-foreground">
                  {t("journey.paragraphs.p1.highlight2")}
                </strong>
                {t("journey.paragraphs.p1.part3")}{" "}
                <strong className="text-foreground">
                  {t("journey.paragraphs.p1.highlight3")}
                </strong>
                .
              </p>
              <p>
                ...
                <strong className="text-foreground">
                  {t("journey.paragraphs.p2.highlight1")}
                </strong>{" "}
                {t("journey.paragraphs.p2.part2")}{" "}
                <strong className="text-foreground">
                  {t("journey.paragraphs.p2.highlight2")}{" "}
              ...
              <p>
                ...
                <strong className="text-foreground">
                  {t("journey.paragraphs.p3.highlight1")}
                </strong>{" "}
                {t("journey.paragraphs.p3.part2")}{" "}
                <strong className="text-foreground">
                  {t("journey.paragraphs.p3.highlight2")}{" "}
                </strong>{" "}
                {t("journey.paragraphs.p3.part3")}{" "}
                <strong className="text-foreground">
                  {t("journey.paragraphs.p3.highlight3")}
                </strong>{" "}
                {t("journey.paragraphs.p3.part4")}{" "}
                <strong className="text-foreground">
                  {" "}
                  {t("journey.paragraphs.p3.highlight4")}{" "}
                </strong>
                , {t("journey.paragraphs.p3.part5")}{" "}
                <strong className="text-foreground">
                  {t("journey.paragraphs.p3.highlight5")}{" "}
                </strong>
                .
              </p>
          ...
          >
            {!statsError &&
              statsSuccess.map((stat) => {
                const LucideIcon = IconMap[stat.iconName];
                const Icon = LucideIcon ? (
                  <LucideIcon className="h-8 w-8 text-primary mx-auto mb-2" />
                ) : (
