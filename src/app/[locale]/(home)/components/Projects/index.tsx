                  ...
                  <CardContent className="h-full space-y-6">
                    <div className="h-full flex flex-col justify-between">
                      <div className="flex flex-col gap-8">
                        ...
                        <div>
                          <h4 className="font-semibold mb-3 text-sm uppercase tracking-wide">{t('technologies.title')}</h4>
                            ...
                            {project.features.map((feature, i) => {
                              ...
                              return (
                                <div key={i} className="flex items-center gap-2 text-sm">
                                  ...
                                  <span>{i === (MAX_NUMBER_OF_FEATURES - 1) && numberOfFeatures > MAX_NUMBER_OF_FEATURES ? t('features.more') : feature}</span>
                                </div>
                              )
                            })}
                          </div>
