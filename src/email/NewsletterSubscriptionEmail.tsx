...
export default function NewsletterSubscriptionEmail({
  ...
  const confirmationUrl = `${envVariables.BASE_URL}/api/newsletter/confirm/${confirmationId}`;
  ...
  return (
    <EmailContainer>
      ...
      <Heading className="mx-0 my-[30px] p-0 text-center font-normal text-[24px] text-black">
        ...
        <EmailStrongTag>{name.split(" ")[0]}</EmailStrongTag>! 🎉
      </Heading>
      ...
      <Text className="text-[14px] text-black leading-[24px]">
        Obs: Se não foi você que solicitou a inscrição, por favor ignore este
        e-mail.
      </Text>
    </EmailContainer>
  );
