...
type FetchBlogPostsCategoriesResponse =
  | [Error, null]
  | [null, BlogCategoriesOptions[]];

export async function fetchBlogPostsCategories(): Promise<FetchBlogPostsCategoriesResponse> {
  return await notionClient<BlogCategoriesOptions[]>(
    ...
    async () => {
      ...
      return databaseInfo.properties.Category.select.options.sort((a, b) =>
