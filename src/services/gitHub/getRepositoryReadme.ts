...
export async function getRepositoryReadme({ full_name }: GetRepositoryReadmeParams): Promise<string | null> {
    ...
    try {
        ...
        apiLogger.error({ stackTrace: error }, `Error to get Readme of ${full_name}`);
        return null
    }
